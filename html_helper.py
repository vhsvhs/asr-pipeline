...
def write_index():
    ...
    fout.write("<p>This library was auto-generated by PhyloBot, using a curated collection of kinase sequences.</p>\n")
    fout.write("<p>Download Sequences: <a href=\"../" + ap.params["ergseqpath"] + "\">fasta (not aligned)</a></p>\n")
